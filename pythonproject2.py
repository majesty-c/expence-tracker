...
e = Listbox(f5,yscrollcommand = sb.set , fg='black',font='Helvetica 18',relief="groove",bg="#e4f5e8") 
...
for student in r_set:  
    ...
    e.insert(END, f"S.N. {student[0]}             {student[1]}               {student[2]}           {student[3]}                {student[4]}                {student[5]}               {student[6]} ")
     
e.pack(side=LEFT,fill=Y,padx=(10, 10),ipadx=420 )              
                
sb.config( command = e.yview )
